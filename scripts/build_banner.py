...
ROWS = [
    ...
    ("Core.Lang",  "C++, C, JavaScript, TypeScript, Python"),
    ("Core.Web",   "React.js, Next.js, Node.js, Express.js, Tailwind CSS"),
    ("Core.Data",  "MongoDB, MySQL, PostgreSQL, Prisma, RESTful APIs"),
    ("Core.GenAI", "RAG, LangChain, LangGraph, Vector Databases"),
    ("Core.Tools", "Git, Docker, Postman, Streamlit, Pytest, Git Bash"),
